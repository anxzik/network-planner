...
metadata:
  ...
  source: atlas:commands/storybook.md
---
...
scripts under `.specify/extensions/atlas/scripts/` carry the parsing, the fail-closed faithfulness gate,
...
compare the output to `.specify/extensions/atlas/examples/speckit-linear-architecture.html` (the
