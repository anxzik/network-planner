...
metadata:
  ...
  source: spec-validate:commands/validate.md
---
...
**For critical items:**
1. Load `.specify/extensions/spec-validate/templates/distractor-patterns.yml` to determine the distractor pattern category:
