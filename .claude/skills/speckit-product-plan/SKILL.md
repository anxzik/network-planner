...
- Product plan template: `.specify/extensions/product/templates/product-plan-template.md` (relative to this command's extension root).
...
Read `.specify/extensions/product/templates/product-plan-template.md`. Populate all sections from `plan.md` (and `spec.md` when available). Apply the following rules without exception.
