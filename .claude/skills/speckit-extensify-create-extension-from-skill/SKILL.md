...
4. Inventory every other file and subdirectory in the skill's enclosing directory (e.g. `.specify/extensions/extensify/scripts/`, `references/`, `assets/`, templates, etc.).
...
└── resources/                    # only if the skill has bundled files
    ├── .specify/extensions/extensify/scripts/                  # copied from skill
...
| `.specify/extensions/extensify/scripts/`, `references/`, `assets/`, other files | `resources/` subtree (preserving directory structure) |
...
- Rewrite relative file references (e.g. `[script](.specify/extensions/extensify/scripts/test.js)`) to point into the `resources/` directory (e.g. `[script](../resources/scripts/test.js)`).
