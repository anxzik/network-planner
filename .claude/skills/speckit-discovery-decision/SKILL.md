...
metadata:
  ...
  source: discovery:commands/decision.md
---
...
5. Create or update the type-specific discovery document by rendering the matching template. Prefer the active feature directory when it exists. Otherwise create the file under `discovery/<short-name>/`.
   ...
   |---|---|---|
   | `api` | `.specify/extensions/discovery/templates/api-integration-discovery.md` | `api-integration-discovery.md` |
   | `performance` | `.specify/extensions/discovery/templates/performance-discovery.md` | `performance-discovery.md` |
   | `migration` | `.specify/extensions/discovery/templates/data-migration-discovery.md` | `data-migration-discovery.md` |
   | `ux` | `.specify/extensions/discovery/templates/ux-discovery.md` | `ux-discovery.md` |
   | `compatibility` | `.specify/extensions/discovery/templates/compatibility-discovery.md` | `compatibility-discovery.md` |
