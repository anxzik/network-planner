...
metadata:
  ...
  source: discovery:commands/poc.md
---
...
7. Create or update `poc-result.md` beside `poc-plan.md` by rendering `.specify/extensions/discovery/templates/poc-result.md` from captured evidence and the classified result.
